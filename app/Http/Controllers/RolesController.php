...
class RolesController extends Controller
{
    ...
    {   
        ...
        return view('roles.roles',compact('roles_datos','permisos', 'text_search'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!($verRol)){
            ...
            return redirect()->route('roles.index')->with('success', 'Registro guardado');

        }else{
            //alert()->success('El Rol ya existe','Mensaje Advertencia');

            return redirect()->back()->with('warning', 'El Rol ya existe');
    ...
    {   $this->actualizarSesion();
        ...
        return redirect()->route('roles.index')->back('danger','Registros borrados');
    }
