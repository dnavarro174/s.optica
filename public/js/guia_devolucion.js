...
$("#add_producto2").click(
	function(e){ 
		...
		let url = baseURL('guia_devolucion/stock/'+cod_artic+'/'+cant+'/'+proy);
		...
		$.ajax({
			...
			success: function(resp){
				...
				if(resp.stock == "A"){
					swal("Atención", "El artículo no tiene stock en el proyecto.", "warning");
					return false;
				}else if(resp.stock == "B"){
					swal("Atención", "El artículo no tiene stock en el proyecto. Stock: "+resp.stock_bd, "warning");
					return false;
				}else if(resp.stock == "C"){
					swal("Atención", "El artículo no cuenta con stock suficiente en el proyecto. Stock disponible: "+resp.stock_bd, "warning");
					return false;
				}else{
