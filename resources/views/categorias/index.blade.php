    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper pt-0">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Categorías  <a class="btn btn-link" href="{{ route('productos.index') }}"><i class="mdi mdi-reply-all"></i> Productos</a></h4>
                  ...
                  <form>
                    <div class="form-row">
                      <div class=" col-sm-10 col-xs-12">
                        ...
                        <?php
                           if (isset($_GET['s'])){ ?>
                           <a class="ml-2 small btn-cerrar btn-link h4" href=' {{route('categorias.index')}} '><i class='mdi mdi-close text-lg-left'></i></a>
                          <?php } ?>
                      </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <form action="{{ route('categorias.eliminarVarios') }}" role='form' method="POST" id="form-delete">
                    {!! csrf_field() !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12  col-sm-8  mb-2">
                        ...
                        <a href="{{ route('categorias.create', ['id'=>$id_tipo]) }}" class="btn btn-dark"><i class="mdi mdi-plus text-white icon-md"></i> Nuevo</a>
                        @endif
