...
<head>
  ...
  <title>EMSAG - Sistema de Control de Inventario</title>
                  ...
                  <form class="forms-sample" id="cursosForm"  action="{{ route('roles.update', $rol_datos->id) }}" method="post">
                    ...
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control text-uppercase" id="rol" name="rol" placeholder="Rol" value="{{ $rol_datos->rol, old('rol') }}" >
                    ...
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control text-uppercase" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ $rol_datos->descripcion, old('descripcion') }}" >
 ...
 /*   $(document).on('click','.optPermiso', function(e){
    ...
    $("#chkConceder").click(
      function(){
        ...
        console.log('click update roles');
