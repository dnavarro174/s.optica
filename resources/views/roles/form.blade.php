                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control text-uppercase" id="rol" name="rol" placeholder="Rol" value="{{ old('name') }}" >
                    ...
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control text-uppercase" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ old('descripcion') }}" >
