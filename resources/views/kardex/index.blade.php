                  ...
                  <div class="row">
                    <div class="col-xl-12 ">{{-- offset-md-1 --}}
                      ...
                      <div class="col-xl-12 row">
                        <h6><a href="{{route('kardex.create')}}" class="btn btn-link view_print p-0"><i class="mdi mdi-reply-all"></i>Regresar</a></h6>
                      </div>
                          ...
                          <input type="hidden" name="ruta_alm" id="ruta_alm" value="{{ route('gt.index') }}">
                                      ...
                                      <table class="table" id="ma_detalle" width="100%">
                                        <thead class="thead-">
                                          <tr>
                                            ...
                                            <th scope="col" class="text-center table-info" width="5%">INGRESO</th>
                                            <th scope="col" class="text-center table-danger" width="5%">SALIDA</th>
                                            <th scope="col" class="text-center table-success" width="5%">SALDO</th>
                                            <th scope="col" class="tab_v" width="10%" rowspan="2">Observaciones</th>
                                          </tr>
                                          <tr>
                                            <th scope="col" class="text-center table-info" width="5%">ICant</th>
                                            <th scope="col" class="text-center table-danger" width="5%">ECant</th>
                                            <th scope="col" class="text-center table-success" width="5%">Saldo</th>
                                          </tr>
                                        </thead>
                                        ...
                                        {{-- <tbody id="filas_contenedor"> --}}
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="5" class="text-left">DESCRIPCIÓN: {{$kar['desc']}}</td>
                                            <td colspan="1" class="text-left">U.M.: {{$kar['um']}}</td>
                                          </tr>
                                          @endif
                              ...
                              <div class="form-group row view_print">
                                <div class="col-sm-12 text-center mt-4">
                                  ...
                                  <a href="{{ route('kardex.create')}}" class="btn btn-light"><i class='mdi mdi-arrow-left'></i>Regresar</a>
                                </div>
