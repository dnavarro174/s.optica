                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      ...
                      <h4 class="card-title mb-4">Tipo de Cambio</h4>
                      ...
                      @endif
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                            <input  disabled type="text" required="" class="form-control" name="TC_compra_mn" placeholder="1" value="{{ $datos->TC_compra_mn }}" />
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                            <input disabled type="text" required="" class="form-control" name="TC_me" placeholder="3.35" value="{{ $datos->TC_me }}" />
                              </div>
                            </div>
