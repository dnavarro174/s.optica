                  ...
                  <div class="row">
                    <div class="col-xl-12 ">{{-- offset-md-1 --}}
                      ...
                      <div class="d-flex justify-content-between mb-4">
                        <h4 class="card-title mb-0">Editar Guía de Transferencia </h4>
                      </div>
                      ...
                      @else
                        ...
                        <form class="forms-sample" id="ingresosForm2"  action="{{ route('gt.update', $datos->id) }}" method="post">
                            {{method_field('PUT')}}
                            {!! csrf_field() !!}
                          @include ('gt.form-edit')
                          <input type="hidden" name="tipo_" id="tipo_" value="transferencia">
