                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      ...
                      <h4 class="card-title mb-4">@if(session('cuenta_tipo') == 1) Clientes @else Proveedores @endif</h4>
                      ...
                      @endif
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="text" class="form-control text-uppercase" id="razon_social" name="razon_social" placeholder="Razón Social" required="" value="{{ $datos->razon_social }}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <textarea disabled="" class="form-control text-uppercase" id="direccion" name="direccion" placeholder="Dirección" cols="30" rows="3">{{ $datos->direccion }}</textarea>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="email" class="form-control text-uppercase" id="e_mail" name="e_mail" placeholder="Email" required="" value="{{ $datos->e_mail }}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="email" class="form-control text-uppercase" id="e_mail_aux" name="e_mail_aux" placeholder="Email 2" value="{{ $datos->e_mail_aux}}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="text" class="form-control text-uppercase" id="tele_contac" name="tele_contac" maxlength="20" placeholder="Telef. Empresa" value="{{ $datos->tele_contac }}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="text" maxlength="20" class="form-control text-uppercase" id="tele" name="tele" placeholder="Telef. Empresa" value="{{ $datos->tele }}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="text" maxlength="100" class="form-control text-uppercase" id="contacto_1" name="contacto_1" placeholder="Nombre de contacto" value="{{ $datos->contacto_1 }}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <input disabled="" type="text" maxlength="100" class="form-control text-uppercase" id="contacto_2" name="contacto_2" placeholder="Nombre de contacto" value="{{ $datos->contacto_2 }}" >
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-xs-12 col-lg-10">
                                  <select disabled="" class="form-control text-uppercase" id="activo" name="activo">
