          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between mb-4">
                <h4 class="card-title mb-0">Guía de Devolución
                  ...
                  <form>
                    <div class="form-row">
                      <div class=" col-sm-7 col-xs-12">
                        ...
                        <?php
                           if (isset($_GET['s'])){ ?>
                           <a class="ml-2 small btn-cerrar h4" href=' {{route('guia_devolucion.index')}} '><i class='mdi mdi-close text-lg-left'></i></a>
                          <?php } ?>
                      </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <form action="{{ route('guia_devolucion.eliminarVarios') }}" role='form' method="POST" id="form-delete">
                    {!! csrf_field() !!}
                    ...
                    <div class="row">{{-- cap: opciones --}}
                      ...
                      <div class="col-xs-12  col-sm-10 text-right mb-4">
                        <div class="form-row ">
                            ...
                            <div class=" col-sm-2 col-xs-12">
                              <a href="{{ route('guia_devolucion.create') }}" class="form-control btn btn-dark"><i class="mdi mdi-plus text-white icon-md"></i> NUEVO</a>
                            </div>
                            @endif
                      ...
                      <div class="col-xs-12 col-sm-2 text-right mb-4">
                        <span class="small pull-left ptt-3">
                          ...
                          {{ $guiaD_datos->firstItem() }} - {{ $guiaD_datos->lastItem() }} de
                          {{ $guiaD_datos->total() }}
                        </span>
                      </div>{{-- end izq --}}
                    ...
                    <div class="row">
                      <div class="col-sm-12 table-responsive-lg">
                        <table id="order-listing" class="table ">
                          ...
                          <tbody>
                            @if(count($guiaD_datos)==0)
                              <th colspan="7">No existe registros</th>
                            @else
                            @foreach ($guiaD_datos as $datos)
                            <tr role="row" class="odd">
                              ...
                              <td nowrap>
                                ...
                                <td><a href="{{ route('guia_devolucion.edit',$datos->id)}}">{{ $datos->nro_doc }}</a></td>
                                <td>{{ $datos->nro_ref }}</td>
                        ...
                        {!! $guiaD_datos->appends(request()->query())->links() !!}
