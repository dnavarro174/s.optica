                  ...
                  <div class="row">
                    <div class="col-xl-12 ">{{-- offset-md-1 --}}
                      <div class="d-flex justify-content-between mb-4">
                        <h4 class="card-title mb-0">Editar Guía de Devolución</h4>
                      </div>                    
                      ...
                      @else
                        ...
                        <form class="forms-sample" id="ingresosForm2"  action="{{ route('guia_devolucion.update', $datos->id) }}" method="post">
                            {{method_field('PUT')}}
                            {!! csrf_field() !!}
                          
                          @include ('guia_devolucion.form-edit')
