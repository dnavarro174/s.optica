                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group mb-2">
                                  <textarea name="descripcion" class="form-control" id="" cols="30" rows="3" placeholder="DESCRIPCIÓN">{{ $productos_datos->descripcion }}</textarea>
                            ...
                            <div class="col-sm-12 col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group mb-2">
                                  <textarea name="ubicacion" class="form-control" id="" cols="30" rows="3" placeholder="UBICACIÓN">{{ $productos_datos->ubicacion }}</textarea>
                            ...
                            <div class="col-sm-12 col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group mb-2">
                                  <input type="number" pattern="^\d*(\.\d{0,2})?$" class="form-control text-uppercase" required="" id="stock_min" name="stock_min" placeholder="STOCK MÍNIMO"  value="{{ $productos_datos->stock_min }}" >
